...
sudo unzip LLAPI.zip

# 将解压出来的目录（假设是LLOnebot）移动到指定位置
sudo mv LiteLoaderQQNT-Plugin-LLOneBot /opt/LiteLoader/plugins/
sudo mv LiteLoaderQQNT-Plugin-LLAPI /opt/LiteLoader/plugins/
